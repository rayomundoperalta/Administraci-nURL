...
namespace Utility.ModifyRegistry
{
    ...
    {
        public ModifyRegistry(string regName)
        {
            /* To Do: Desarrollar una verificación via WebService de si se puede dar el servicio o no */
            subKey = "Software\\" + regName.ToUpper();
        }
